  ...
  <form action="" method="post" name="parkingform" id="parkingform">
    <div class="section">
      <p>
        ...
        <input type="text" name="id" id="id" placeholder="Введите номер парковки" value="${idRet}">
        <input name="get" type="submit" id="get" value="Получить парковку по номеру">
      </p>
      <p>
        <label for="maxCapacity">Максимальная вместимость</label>
        <input type="text" name="maxCapacity" id="maxCapacity" placeholder="Введите максимальную вместимость" value="${maxCapacityRet}">
      </p>
      <p>
        <label for="parkingAddress">Адрес</label>
        <input type="text" name="parkingAddress" id="parkingAddress" placeholder="Введите адрес парковки" value="${parkingAddressRet}">
      </p>
      <p>
    ...
    <c:forEach var="parking" items="${parkings}">
      <div class="card">
        <form action="" method="post" name="oneParkingform" id="oneParkingform">
          <c:out value="${parking.allInString()}"></c:out>
          <input type="hidden" name="idOther" id="idOther" value="${parking.getId()}">
          <input type="hidden" name="maxCapacityOther" id="maxCapacityOther" value="${parking.getMaxCapacity()}">
          <input type="hidden" name="parkingAddressOther" id="parkingAddressOther" value="${parking.getParkingAddress()}">
